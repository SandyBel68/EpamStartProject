...
--
-- Host: 127.0.0.1    Database: floordb
-- ------------------------------------------------------
...
--
-- Table structure for table `movetracker`
--
...
--
-- Dumping data for table `movetracker`
--

LOCK TABLES `movetracker` WRITE;
/*!40000 ALTER TABLE `movetracker` DISABLE KEYS */;
/*!40000 ALTER TABLE `movetracker` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-15 16:56:02
